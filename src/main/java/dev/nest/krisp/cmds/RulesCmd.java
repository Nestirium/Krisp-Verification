    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (Utils.isPrefix(event.getGuild().getId(), message)) {
            try {
                ...
                if (args[0].equalsIgnoreCase(data.getPrefix() + "rules")) {
                    switch (args.length) {
                        case 1:
                            ...
                            if (data.getRules_roleToBeRemoved() != null) {
                                if (!data.getRules_roleToBeRemoved().equalsIgnoreCase("null")) {
                                    builder.addField("Removal Role", data.getRulesRoleToBeRemoved().getAsMention(), false);
                                } else {
                                    builder.addField("Removal Role", "❌\nrules setremoval <roleid>", false);
                                }
                            }
                        ...
                        case 2:
                            if (args[1].equalsIgnoreCase("toggle")) {
                                if (data.getRulesEnabled()) {
                                    data.getRulesChannel().deleteMessageById(data.getRules_messageId()).queue();
                        ...
                        case 3:
                            if (args[1].equalsIgnoreCase("setremoval")) {
                                if (NumberUtils.isNumber(args[2])) {
                                    ...
                                    if (role != null) {
                                        data.setRules_roleToBeRemoved((role.getId()));
                                        builder.setTitle("✅ Success");
