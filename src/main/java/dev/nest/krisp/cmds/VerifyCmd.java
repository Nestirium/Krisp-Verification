    ...
    public void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (Utils.isPrefix(event.getGuild().getId(), message)) {
            try {
                ...
                if (args[0].equalsIgnoreCase(data.getPrefix() + "verify")) {
                    switch (args.length) {
                        case 1:
                            if (data.hasVerifImage()) {
                            ...
                            if (data.getVerif_message() != null) {
                                if (!data.getVerif_message().equalsIgnoreCase("null")) {
                            ...
                            if (data.getVerif_messageId() != null) {
                                if (!data.getVerif_messageId().equalsIgnoreCase("null")) {
                                    builder.addField("Message ID", data.getVerif_messageId(), false);
                                } else {
                            ...
                            if (data.getVerifRoleToBeRemoved() != null) {
                                builder.addField("Removal Role", data.getVerifRoleToBeRemoved().getAsMention(), false);
                            } else {
                                builder.addField("Removal Role", "❌\nverify setremoval <roleid>", false);
                            }
                        ...
                        case 2:
                            if (args[1].equalsIgnoreCase("toggle")) {
                                if (data.getVerifEnabled()) {
                                    data.getVerifChannel().deleteMessageById(data.getVerif_messageId()).queue();
                                    data.setVerif_messageId(null);
                                    ...
                                    if (data.isVerifComplete()) {
                                        if (data.getVerifChannel() != null) {
                                            ...
                                            builder.setDescription(data.getVerif_message());
                                            ...
                                            data.getVerifChannel().sendMessage(builder.build()).queue((m) -> {
                                                ...
                                                data.setVerif_messageId(m.getId());
                                            });
                                            builder.clear();
                            ...
                            if (args[1].equalsIgnoreCase("setremoval")) {
                                builder.setTitle("❌ Error");
                                builder.setDescription("Incorrect usage!\nverify setremoval <roleid>");
                                builder.setColor(Color.RED);
                                event.getChannel().sendTyping().queue();
                                event.getChannel().sendMessage(builder.build()).queue();
                                builder.clear();
                        ...
                        case 3:
                            if (args[1].equalsIgnoreCase("setremoval")) {
                                if (NumberUtils.isNumber(args[2])) {
                                    ...
                                    if (role != null) {
                                        data.setVerif_roleToBeRemoved((role.getId()));
                                        builder.setTitle("✅ Success");
                                        builder.setDescription("Removal role is now set to " + role.getAsMention());
                                        builder.setColor(Color.GREEN);
                                    } else {
                                        builder.setTitle("❌ Error");
